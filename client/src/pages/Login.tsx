        ...
        <Card className="border border-border/50 shadow-xl shadow-primary/5 backdrop-blur-xl bg-white/80 dark:bg-slate-900/80 rounded-3xl overflow-hidden">
          ...
          <CardContent className="pt-4 pb-8 px-8">
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              >
                <Button
                  type="button"
                  variant="ghost"
                  className="w-full h-10 rounded-xl justify-start text-sm text-muted-foreground hover:text-primary hover:bg-primary/5 transition-all"
            ...
            >
              <Button
                variant="outline"
                className="h-11 rounded-full border-border/70 font-medium"
              >
