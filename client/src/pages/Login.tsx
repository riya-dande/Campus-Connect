...
import { GraduationCap, Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, Zap } from "lucide-react";
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        <Card className="border border-border/50 shadow-xl shadow-primary/5 backdrop-blur-xl bg-white/80 dark:bg-slate-900/80 rounded-3xl overflow-hidden">
          {/* Header Gradient */}
          ...
          <CardHeader className="text-center pb-2 pt-8">
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-br from-primary to-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-primary/25">
          ...
          <CardContent className="pt-4 pb-8 px-8">
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-12 pl-12 pr-4 rounded-xl bg-muted/50 border-border/50 focus:bg-white dark:focus:bg-slate-800 transition-all"
                    required
                  />
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-12 pl-12 pr-12 rounded-xl bg-muted/50 border-border/50 focus:bg-white dark:focus:bg-slate-800 transition-all"
                    required
                  />
                  <button
                    type="button"
              ...
              >
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-12 rounded-xl font-semibold text-base shadow-lg shadow-primary/25 hover:shadow-primary/40 transition-all"
                >
                  {isLoading ? (
              ...
              >
                <Button
                  type="button"
                  variant="ghost"
                  className="w-full h-10 rounded-xl text-sm text-muted-foreground hover:text-primary hover:bg-primary/5 transition-all"
                  onClick={fillDemoCredentials}
                  onMouseEnter={() => setIsHoveringDemo(true)}
                  onMouseLeave={() => setIsHoveringDemo(false)}
                >
                  <Zap className={cn("w-4 h-4 mr-2", isHoveringDemo && "text-yellow-500")} />
                  Fill Demo Credentials
                  <motion.span
                    animate={{ opacity: isHoveringDemo ? 1 : 0, x: isHoveringDemo ? 0 : -10 }}
                    className="ml-2 text-xs"
                  >
                    (alex@campus.edu / alex123)
                  </motion.span>
                </Button>
              </motion.div>
            </form>
            ...
            >
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white dark:bg-slate-900 px-4 text-muted-foreground/50">
                  Or continue with
                </span>
              </div>
            </motion.div>
